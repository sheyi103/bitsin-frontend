<template>
  <div>
    <div class="">
      <div class="row">
        <div class="col-lg-6 offset-md-3 col-md-6 col-xl-6 col-xxl-6 rounded-2 shadow-lg bgwhite">
          <div class="p-5 mob-contact-space">
            ...
            <form action="">
              ...
              <div class="py-2">
                ...
                <br />
                <input v-model="form.email" type="email" class="rounded-1 p-2 w-100"
              ...
              <div class="py-2">
                ...
                <br />
                <input v-model="form.name" type="text" class="rounded-1 p-2 w-100" placeholder="enter your Name" />
              </div>
              <!--Phone Number -->
              <div class="py-2">
                <label for="" class="fs-200 py-2">Phone Number</label>
                <br />
                <input v-model="form.phone" type="text" class="rounded-1 p-2 w-100"
              ...
              <div class="row">
                <div class="py-2 col-md-6">
                  ...
                  <br />
                  <input v-model="form.inbound" type="text" class="rounded-1 p-2 w-100"
                    placeholder="enter your phone Number" />
                </div>
                ...
                <div class="py-2 col-md-6">
                  ...
                  <br />
                  <input v-model="form.outbound" type="text" class="rounded-1 p-2 w-100"
                    placeholder="enter your phone Number" />
                </div>
              </div>
              ...
              <div class="row">
                <div class="py-2 col-md-6">
                  ...
                  <br />
                  <input v-model="form.arrival" type="date" class="rounded-1 p-2 w-100"
                    placeholder="enter your phone Number" />
                </div>
                ...
                <div class="py-2 col-md-6">
                  ...
                  <br />
                  <input v-model="form.destination" type="date" class="rounded-1 p-2 w-100"
                    placeholder="enter your phone Number" />
                </div>
              </div>
              ...
              <div class="row">
                <div class="py-2 col-md-4">
                  ...
                  <br />
                  <input v-model="form.adult" type="number" class="rounded-1 p-2 w-100"
                ...
                <div class="py-2 col-md-4">
                  ...
                  <br />
                  <input v-model="form.child" type="number" class="rounded-1 p-2 w-100"
                    placeholder="enter number children" />
                </div>
                <div class="py-2 col-md-4">
                  <label for="" class="fs-200 py-2">No. of Infants(optional)</label>
                  <br />
                  <input v-model="form.infant" type="number" class="rounded-1 p-2 w-100"
              ...
              <div class="py-2">
                ...
                <br />
                <textarea v-model="form.message" name="" id="" cols="20" rows="5" class="w-100"
...
export default {
  ...
  // head() {
  //   return {
  //     title: "Bitsin Travles Booking",
  //     meta: [
  //       { charset: "utf-8" },
  //       { name: "viewport", content: "width=device-width, initial-scale=1" },
  //       {
  //         hid: "description",
  //         name: "Hotels, Flights, Booking, Travels and Tours in booking page",
  //         content: "",
  //       },
  ...
  data() {
    return {
      form: {},
      isLoading: false,
      paystackkey: "pk_test_fe544cc16e131b215edf8b841863a47a4c654e27", //paystack public key
      email: "seyiolawepo@gmail.com", // Customer email
  ...
  methods: {
    ...
    async sendRequest() {
            this.$paystack({
        key: 'pk_test_fe544cc16e131b215edf8b841863a47a4c654e27', // Replace with your public key.
        email: 'seyiolawepo@gmail.com',
        amount: 100000,
        ref: this.reference,
        currency: 'NGN',
        channels: ['card'],
